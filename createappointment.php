...
<html data-bs-theme="light" lang="en">
  ...
  <body style="background: rgb(221, 221, 221)">
        ...
        <div class="container">
          <a
            ...
            style="padding-bottom: 0px; margin-top: 0px; padding-top: 0px"
                ><img src="assets/img/Untitled-1.png" style="width: 109px"
    /></a>
        </div>
      </nav>
    ...
    <!-- End: nav bar -->
    <div style="margin-bottom: 31px; margin-top: -30px">
          ...
          <div class="col" style="margin-top: 0px; padding-top: 0px">
            <div
              ...
              style="
                ...
                min-height: 630px;
                margin-top: 119px;
                background: url('assets/img/7749159.png') center / cover
                    no-repeat,
                  rgba(255, 255, 255, 0.79);
                border-radius: 10px;
              "
                  >
              <form style="padding-top: 70px; margin-top: -47px">
